...
class ApiKeyController extends SettingController
{
    protected function breadcrumb(): Breadcrumb
    {
        return parent::breadcrumb()
            ->add(trans('packages/cloudify::cloudify.setting.api_key.title'), route('cloudify.api-keys.index'));
    }

    public function index(ApiKeyTable $apiTokenTable)
    {
        $this->pageTitle(trans('packages/cloudify::cloudify.setting.api_key.title'));
    ...
    {
        return DeleteResourceAction::make($key);
    }
}
