        ...
        $this
            ...
            ->add(
                ...
                TextFieldOption::make()
                    ->label(trans('packages/cloudify::cloudify.setting.api_key.token'))
            ...
            ->add(
                ...
                RadioFieldOption::make()
                    ->label(trans('packages/cloudify::cloudify.setting.api_key.type'))
                    ->helperText(trans('packages/cloudify::cloudify.setting.api_key.type_helper'))
            ...
            ->add(
                ...
                OnOffFieldOption::make()
                    ->helperText(trans('packages/cloudify::cloudify.setting.api_key.special_helper'))
                    ->label(trans('packages/cloudify::cloudify.setting.api_key.special'))
            );
    }
}
