...
return [
    ...
    'setting' => [
        ...
        'google_drive' => [
            'enable' => 'Enable Google Drive Storage',
            'client_id' => 'Client ID',
            'client_id_placeholder' => 'Enter your Google Drive Client ID',
            'client_secret' => 'Client Secret',
            'client_secret_placeholder' => 'Enter your Google Drive Client Secret',
            'refresh_token' => 'Refresh Token',
            'refresh_token_placeholder' => 'Enter your Google Drive Refresh Token',
            'folder_id' => 'Root Folder ID',
            'folder_id_placeholder' => 'Enter your Google Drive Folder ID (optional)',
        ],
        'api_key' => [
            'title' => 'API Keys',
            'token' => 'Token',
    ...
    'enums' => [
        ...
        'external_ability' => [
            ...
            'view_media_folder' => 'View Media Folder',
